...
The pragmatic 2026 stance: **support both in the LIMS, prefer v2 when the partner offers both, plan a multi-year migration to FHIR for new integrations.** This is the stance [LabFlow's EMR Integration module](https://docs.labflow.aoneahsan.com/docs/modules/emr-integration) takes; this post explains why.
...
A lab that supports both protocols typically maintains a per-connection mapping table that translates partner test codes to LOINC and vice-versa — the [LabFlow EMR Integration page](https://docs.labflow.aoneahsan.com/docs/modules/emr-integration#field-mapping-editor--every-option) documents the canonical shape.
